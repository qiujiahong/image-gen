...
- `GEMINI_BASE_URL` — API 基础地址（默认：`https://api.xheai.cc/v1beta`）
- `GEMINI_MODEL` — 通用 Gemini 模型（可选）
- `GEMINI_IMAGE_MODEL` — 图像生成模型，默认 `nano-banana-2`

兼容旧变量：`IMAGE_GEN_API_KEY`、`IMAGE_GEN_BASE_URL`。
...
```bash
export GEMINI_API_KEY="sk-zxWwm8j4iabi2IJmyccGTXR1zIppV6tcilXs35iCiIafPeiw"
export GEMINI_BASE_URL="https://api.xheai.cc/v1beta"
export GEMINI_MODEL="gemini-3-flash-preview"
export GEMINI_IMAGE_MODEL="nano-banana-2"
